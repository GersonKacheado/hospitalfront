...
<div class="wrapper">
      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-12 text-center">
            <h1 class="text-uppercase">cadastro individual</h1>
          </div>
  ...
  <div class="form-row pl-5">
    <div class="col-md-3 mb-3">
      <label for="validationCustom01">CNS DO PROFISSIONAL:</label>
      <input type="text" class="form-control" id="validationCustom01" placeholder="CNS DO PROFISSIONAL"  required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-2 mb-3">
      <label for="validationCustom01">CBO:</label>
      <input type="text" class="form-control" id="validationCustom01" placeholder="CBO"  required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom01">CNES:</label>
      <input type="text" class="form-control" id="validationCustom01" placeholder="CNES"  required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-2 mb-3">
      <label for="validationCustom01">INE:</label>
      <input type="text" class="form-control" id="validationCustom01" placeholder="INE" required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom01" placeholder="DATA"  required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>    
...
<div class="card-text">
    <div class="card-header">
<h6 class="text-uppercase">identificação do usuario/cidadão</h6>
    </div>
  <div class="form-row pl-5 mt-2">
    <div class="col-md-4 mb-3">
      <label for="validationCustom03">CNS DO CIDADÃO:</label>
      <input type="text" class="form-control" id="validationCustom03" placeholder="CNS DO CIDADÃO" required>
      <div class="invalid-feedback">
        Please provide a valid city.
      </div>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom03">CIDADÃO É RESPONSAVEL FAMILIAR?</label>
      <input type="text" class="form-control" id="validationCustom03" placeholder="CIDADÃO É RESPONSAVEL FAMILIAR?" required>
      <div class="invalid-feedback">
        Please provide a valid city.
      </div>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom03">CNS DO RESPONSAVEL FAMILIAR</label>
      <input type="text" class="form-control" id="validationCustom03" placeholder="CNS DO RESPONSAVEL FAMILIAR" required>
      <div class="invalid-feedback">
        Please provide a valid city.
      </div>
    </div>
    <div class="col-md-2 mb-3">
      <label for="validationCustom04">MICROAREA</label>
      <input type="text" class="form-control" id="validationCustom04" placeholder="MICROAREA" required>
      <div class="invalid-feedback">
    ...
    <div class="col-md-7 mb-3">
      <label for="validationCustom04">NOME COMPLETO</label>
      <input type="text" class="form-control" id="validationCustom04" placeholder="NOME COMPLETO" required>
      <div class="invalid-feedback">
        Please provide a valid state.
      </div>
    </div>
  ...
  <div class="form-row pl-5">
    ...
    <div class="col-md-3 mb-3">
      <label for="validationCustom05">ETNIA:</label>
      <input type="text" class="form-control" id="validationCustom05" placeholder="ETNIA" required>
      <div class="invalid-feedback">
        Please provide a valid zip.
      </div>
    </div>
    <div class="col-md-3 mb-3">
      <label for="validationCustom05">Nº NIS (PIS/PASEP):</label>
      <input type="text" class="form-control" id="validationCustom05" placeholder="Nº NIS (PIS/PASEP):" required>
      <div class="invalid-feedback">
        Please provide a valid zip.
      </div>
    </div>
  ...
  <div class="col-md-10 mb-3">
      <label for="validationCustom04">NOME COMPLETO DA MÃE:</label>
      <input type="text" class="form-control" id="validationCustom04" placeholder="NOME COMPLETO DA MÃE" required>
      <div class="invalid-feedback">
        Please provide a valid state.
      </div>
    </div>
    ...
    <div class="col-md-2 mb-3">
      <label for="validationCustom05">DESCONHECIDO:</label>
